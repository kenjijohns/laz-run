<?php 
  ...
  $w = "300px"; // Example dynamic value for button width
  $color = "#ff0000"; // Example dynamic value for button color
  $mb = "30px"; // Example dynamic value for button margin-bottom
?>

@import url("https://fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap");

:root {
    --button-width: <?php echo $w; ?>;
    --button-color: <?php echo $color; ?>;
    --button-margin-bottom: <?php echo $mb; ?>;
  }
