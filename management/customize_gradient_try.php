...
$cssVariables = [
    ...
    'button_background_color' => extract_css('--button_background-color'),
                ...
                <form id="customize-form" method="post"  enctype="multipart/form-data">
                    ...
                    foreach ($configData as $group) {
                        ...
                        switch ($setting['type']) {
                            ...
                            case 'background':
                                    foreach ($setting['options'] as $option) {
                                        echo '<input type="radio" id="' . $option['id'] . '" name="' . $option['name'] . '" value="' . $option['name'] . '" ' . ($currentSettingValue == $option['name'] ? 'checked' : '') . '>';
