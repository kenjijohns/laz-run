                ...
                <div id="preview">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select name="page" id="page" class="custom-select data" onchange="redirectToPage(this)">
                                <option value="customize.php" <?php if($currentPage === 'customize.php') echo 'selected'; ?>>Home</option>
                                <option value="customize_category.php" <?php if($currentPage === 'customize_category.php') echo 'selected'; ?>>Category</option>
                                <option value="customize_quiz.php" <?php if($currentPage === 'customize_quiz.php') echo 'selected'; ?>>Quiz</option>
                                <option value="customize_result.php" <?php if($currentPage === 'customize_result.php') echo 'selected'; ?>>Result</option>
                            </select>
                                <script>
                    ...
                    <div id="iframe-container">
                        <iframe id="preview-iframe" src="./demo_category.php"></iframe>
                    </div>
                </div>  
            </div>
        </div>
