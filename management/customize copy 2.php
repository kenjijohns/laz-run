    ...
    <div class="container-fluid">
            ...
            <div class="col-md-3">
                ...
                <form id="customize-form" method="post">
                    ...
                    $variables = json_decode(file_get_contents('variables.json'), true);

                    // Loop through the variables array and generate form elements
                    foreach ($variables as $variable) {
                        echo '<div class="form-group">';
                        echo '<label for="' . $variable['name'] . '">' . $variable['label'] . '</label>';

                        switch ($variable['type']) {
                            case 'text':
                                echo '<input type="text" id="' . $variable['name'] . '" name="' . $variable['name'] . '">';
                                break;
                            case 'radio':
                                echo '<div class="radio-buttons">';
                                foreach ($variable['options'] as $option) {
                                    echo '<input type="radio" id="' . $option['value'] . '" name="' . $variable['name'] . '" value="' . $option['value'] . '">';
                                    echo '<label for="' . $option['value'] . '">' . $option['label'] . '</label>';
                                }
                                echo '</div>';
                                break;
                            case 'select':
                                echo '<select id="' . $variable['name'] . '" name="' . $variable['name'] . '">';
                                foreach ($variable['options'] as $option) {
                                ...
                                break;
                            case 'color':
                                echo '<input type="color" id="' . $variable['name'] . '" name="' . $variable['name'] . '">';
                                break;
                            // Add more cases for other form field types as needed
                            default:
                                echo 'Unsupported field type: ' . $variable['type'];
                        }
