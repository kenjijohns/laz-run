...
$cssVariables = [
    ...
    'h1_margin' => extract_css('--h1_margin'),
...
$h1_margin = $_POST['h1_margin'] ?? $current_value['h1_margin'];
...
<body>
    <div class="container-fluid">
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <h5>h1</h5>
                    <label for="h1_font-size">Font Size:</label>
                    <div class="radio-buttons">
                        <input type="radio" id="small_font" name="h1_font-size" value="clamp(18px, 2vw, 36px)" <?php if ($h1_font_size === "clamp(18px, 2vw, 36px)") echo "checked"; ?>>
                        <label for="small_font">Small</label>

                        <input type="radio" id="medium_font" name="h1_font-size" value="clamp(24px, 2vw, 46px)" <?php if ($h1_font_size === "clamp(24px, 2vw, 46px)") echo "checked"; ?>>
                        <label for="medium_font">Medium</label>

                        <input type="radio" id="large_font" name="h1_font-size" value="clamp(34px, 2vw, 56px)" <?php if ($h1_font_size === "clamp(34px, 2vw, 56px)") echo "checked"; ?>>
                        <label for="large_font">Large</label>
                    </div>
                </div>
            <div class="form-group">
                <label for="h1_font-weight">h1 Font Weight:</label>
                <div class="radio-buttons">
                    <input type="radio" id="bold_font" name="h1_font-weight" value="bold">
                    <label for="bold_font">Bold</label>

                    <input type="radio" id="normal_font" name="h1_font-weight" value="normal">
                    <label for="normal_font">Normal</label>
                </div>
            </div>
            <div class="form-group">
                <label for="h1_letter-spacing">h1 Letter Spacing:</label>
                <div class="radio-buttons">
                    <input type="text" id="h1_letter-spacing" name="h1_letter-spacing" value = "<?php echo $h1_letter_spacing?>">
                </div>
            </div>
            <div class="form-group">
                <label for="h1_line-height">h1 Line Height:</label>
                <div class="radio-buttons">
                    <input type="text" id="h1_line-height" name="h1_line-height" value = "<?php echo $h1_line_height?>">
                </div>
            </div>
            <div class="radio-buttons">
                <input type="radio" id="h1_text-align-left" name="h1_text-align" value="left" <?php if ($h1_text_align === "left") echo "checked"; ?>>
                <label for="h1_text-align-left">Left</label>

                <input type="radio" id="h1_text-align-center" name="h1_text-align" value="center" <?php if ($h1_text_align === "center") echo "checked"; ?>>
                <label for="h1_text-align-center">Center</label>

                <input type="radio" id="h1_text-align-right" name="h1_text-align" value="right"  <?php if ($h1_text_align === "right") echo "checked"; ?>>
                <label for="h1_text-align-right">Right</label>
            </div>
            <div class="form-group">
                <label for="h1_color">h1 Color:</label>
                <input type="color" name="h1_color" id="h1_color" class="form-control" value="<?php echo $h1_color; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                        <label for="h1_margin_top">Top:</label>
                        <input type="text" id="h1_margin_top" name="h1_margin_top">
                    </div>
                    <div class="col">
                        <label for="h1_margin_right">Right:</label>
                        <input type="text" id="h1_margin_right" name="h1_margin_right">
                    </div>
                    <div class="col">
                        <label for="h1_margin_bottom">Bottom:</label>
                        <input type="text" id="h1_margin_bottom" name="h1_margin_bottom">
                    </div>
                    <div class="col">
                        <label for="h1_margin_left">Left:</label>
                        <input type="text" id="h1_margin_left" name="h1_margin_left">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function handleInputChange(event) {
            ...
            case 'h1_font-size':
                updateCSSVariable('--h1_font-size', event.target.value);
                break;
            case 'h1_font-weight':
                updateCSSVariable('--h1_font-weight', event.target.value);
                break;
            case 'h1_letter-spacing':
                updateCSSVariable('--h1_letter-spacing', event.target.value);
                break;
            case 'h1_line-height':
                updateCSSVariable('--h1_line-height', event.target.value);
                break;
            case 'h1_text-align':
                updateCSSVariable('--h1_text-align', event.target.value);
                break;
            case 'h1_color':
                updateCSSVariable('--h1_color', event.target.value);
                break;
            case 'h1_margin_top':
            case 'h1_margin_right':
            case 'h1_margin_bottom':
            case 'h1_margin_left':
                updateH1Margin();
                break;
    ...
    function updateH1Margin() {
        var top = document.getElementById('h1_margin_top').value || '0';
        var right = document.getElementById('h1_margin_right').value || '0';
        var bottom = document.getElementById('h1_margin_bottom').value || '0';
        var left = document.getElementById('h1_margin_left').value || '0';

        var h1MarginValue = `${top}px ${right}px ${bottom}px ${left}px`;

        updateCSSVariable('--h1_margin', h1MarginValue);
    }
