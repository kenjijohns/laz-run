...
document.addEventListener('DOMContentLoaded', function() {
    ...
    gradientForms.forEach(function(gradientForm) {
        ...
        console.log(colorStopInput);
        for (var i = 0; i < colorStopInput.length; i++) {
            colorStopInput[i].addEventListener('input', handleGradient);
        }
        ...
        function handleGradient(event) {
            ...
            console.log( colorStopHiddenInput.value = JSON.stringify(colorStops));
        }
    });
});
